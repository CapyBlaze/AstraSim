...
<p align="center">
  <img src="https://img.shields.io/github/license/CapyBlaze/AstraSim?style=flat-square" alt="LICENSE"/>
...
<div align="center">
  <h3>
    <a href="https://capyblaze.github.io/AstraSim/" target="_blank">
      👉 Live Demo 👈
    </a>
  </h3>
</div>
...
```bash
git clone https://github.com/CapyBlaze/AstraSim.git
cd AstraSim
```
